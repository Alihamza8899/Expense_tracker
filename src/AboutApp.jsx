  ...
  return (
    <div id="about" className="text-white">
      ...
      <div className=" w-full md:w-[60%] mx-auto py-8 px-4 text-lg font-semibold">
        ...
        helps you stay in control. <br /> Managing money doesn’t have to be
        stressful. Expense Tracker makes it easy to record your expenses,
        monitor your spending, and stay on top of your budget. With clear
        insights and a clean design, you can focus less on calculations and more
